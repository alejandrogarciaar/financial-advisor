...
| `bitstamp_client.py` | OHLC diario y de 4h público de Bitstamp (sin API key) — fuente SOLO de "📐 Niveles calculados" en Cripto, porque es el feed `BTCUSD` de TradingView sobre el que Crecetrader dibuja sus niveles. |
